...
export function CalendarCell({
  ...
  const finallyIsDisable = isDisabled || isUnavailable;
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={cn(
            'size-full flex items-center justify-center text-sm font-semibold rounded-sm',
            finallyIsDisable ? 'text-muted-foreground cursor-not-allowed' : '',

            isSelected ? 'bg-primary text-white' : '',

            !isSelected && !finallyIsDisable ? 'bg-secondary' : '',
          )}
        >
          {formattedDate}
          {isDateToday && (
